function [alpha, xalpha, falpha, gradalpha, fail, beta, gradbeta, fevalrec, nfeval] = ...
          linesch_ww(x0, f0, grad0, d, pars, c1, c2, fvalquit, prtlevel)
      
% Last change: 25.01.2021 by Marco Sutti.

%   Jan 25, 2021:
%       Fixed the logic operators and added trace() at lines 142 and 173.
